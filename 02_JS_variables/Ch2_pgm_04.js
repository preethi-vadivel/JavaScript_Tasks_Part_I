...
score = 200; // Updating the value of 'score' to 200

var score2;
score2 = 250; // Assigning an initial value to 'score`

console.log(score2); // Output: 250

score2 = 300; // Changing the value of score2'
